...
public class TestAnnotModel_D_DtoResponse {
    private long id;
    private String name;
    private String route;
    private List<TestAnnotModel_C_DtoResponse> testAnnotModelCList;
    ...
    public List<TestAnnotModel_C_DtoResponse> getTestAnnotModelCList() {
        return testAnnotModelCList;
    }

    public void setTestAnnotModelCList(List<TestAnnotModel_C_DtoResponse> testAnnotModelCList) {
